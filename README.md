...
Moodseed 是一款以 **情绪记录 + 认知行为疗法(CBT) + 植物拼图成长** 为核心的轻量移动端 Web 产品。每次有效记录由 AI 辅助完成情绪识别与建议，并推动一株灰暗破败的植物恢复一块生命力；36 块全部点亮后，解锁完整植物卡片。
...
- **植物拼图**：36 块（6×6）三态、灰→彩逐块点亮、左右滑动、完整解锁翻牌、植物卡片
