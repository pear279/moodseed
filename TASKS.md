...
- [x] 6.5 `pnpm build` 全量通过 + 部署 Cloudflare Pages + 验证公网（https://moodseed.pages.dev/；D1 已建+迁移；图片上传改 Cloudinary 直传）
...
- [x] Cloudflare 真实部署可访问（https://moodseed.pages.dev/；首页/API/D1 均已验证，图片上传走 Cloudinary）
